...
/**
 * TriangleClassifierKilledMutant
 *
 ...
 */
public class TriangleClassifierKilledMutant {
    ...
    public static String classify(int a, int b, int c) {
        ...
        if (a == b && b == c) {
            // Modificare mutantă: înlocuim returnarea "EQUILATERAL" cu "ISOSCELES"
            // pentru triunghiurile echilaterale.
            // Original: return "EQUILATERAL";
            // Mutant: return "ISOSCELES";
            // Această modificare face ca programul să clasifice greșit triunghiurile
            // echilaterale, returnând "ISOSCELES" în loc de "EQUILATERAL". Astfel,
            // mutantul este detectabil deoarece există teste care verifică corectitudinea
            // clasificării triunghiurilor echilaterale.
            return "ISOSCELES";
        }
